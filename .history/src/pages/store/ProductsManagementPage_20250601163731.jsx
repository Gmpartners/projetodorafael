  ...
  return (
    <MainLayout userType="store" pageTitle="Gestão de Produtos">
      ...
      <div className="space-y-4 sm:space-y-6 w-full max-w-full overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex items-center space-x-3 w-full lg:w-auto">
              ...
              <Dialog open={isAddingProduct} onOpenChange={() => {}}>
                ...
                <DialogContent 
                  className="w-[98vw] max-w-[1400px] max-h-[95vh] overflow-hidden flex flex-col"
                ...
                >
                  ...
                  <div className="flex-1 overflow-hidden">
                    <Tabs defaultValue="basic" className="h-full flex flex-col">
                      <TabsList className="flex-shrink-0 grid w-full grid-cols-2 mb-6 h-14">
                        <TabsTrigger value="basic" className="text-sm sm:text-base font-medium py-3">
                          📋 Informações Básicas
                        </TabsTrigger>
                        <TabsTrigger value="steps" className="text-sm sm:text-base font-medium py-3">
                      ...
                      <div className="flex-1 overflow-y-auto">
                        <TabsContent value="basic" className="space-y-8 mt-0">
                          <div className="grid grid-cols-1 2xl:grid-cols-3 gap-8">
                            ...
                            <div className="2xl:col-span-2 space-y-8">
                              <div>
                                <Label htmlFor="displayName" className="text-lg font-semibold text-gray-900 flex items-center mb-4">
                                ...
                                <Input
                                  ...
                                  className={`h-14 text-lg ${errors.displayName ? 'border-red-300 bg-red-50' : 'border-gray-300'}`}
                                />
                                {errors.displayName && (
                              ...
                              <div>
                                <Label htmlFor="description" className="text-lg font-semibold text-gray-900 flex items-center mb-4">
                            ...
                            <div className="2xl:col-span-1">
                              <Label className="text-lg font-semibold text-gray-900 flex items-center mb-6">
                              ...
                              <div className="space-y-6">
                                ...
                                {(imagePreview || newProduct.image) && (
                                  <div className="relative w-full aspect-square max-w-80 rounded-xl overflow-hidden border-2 border-purple-200 bg-purple-50 mx-auto">
                                    <img 
                        ...
                        <TabsContent value="steps" className="space-y-6 mt-0">
                          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-purple-50 p-6 rounded-lg border border-purple-200">
                            <div>
                              <h3 className="text-xl font-semibold text-gray-900 flex items-center">
                                <Sparkles className="h-6 w-6 mr-3 text-purple-600" />
                                Etapas Personalizadas
                              </h3>
                              <p className="text-gray-600 mt-2 text-base">Configure o que o cliente verá no acompanhamento do pedido</p>
                              {errors.customSteps && (
                                <p className="text-red-600 text-sm mt-2 flex items-center">
                                  <AlertCircle className="h-4 w-4 mr-1" />
                                  {errors.customSteps}
                            ...
                            <Button
                              ...
                              className="bg-purple-600 hover:bg-purple-700 h-14 px-8 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                            >
                          ...
                          {newProduct.customSteps.length === 0 ? (
                            <div className="text-center py-20 bg-gradient-to-br from-gray-50 to-purple-50 rounded-xl border-2 border-dashed border-purple-300">
                              <Sparkles className="h-24 w-24 mx-auto mb-8 text-purple-300" />
                              <h3 className="text-2xl font-semibold text-gray-700 mb-4">
                                Nenhuma etapa configurada
                              </h3>
                              <p className="text-gray-500 mb-10 text-lg px-4 max-w-lg mx-auto">
                                Adicione pelo menos 1 etapa para que seus clientes possam acompanhar o progresso
                              </p>
                              <Button 
                                onClick={addCustomStep}
                                className="bg-purple-600 hover:bg-purple-700 h-14 px-10 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                              >
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                              {newProduct.customSteps.map((step, index) => (
                                <Card key={index} className="p-8 border-l-4 border-l-purple-400 bg-gradient-to-r from-purple-50/50 to-transparent shadow-sm hover:shadow-md transition-shadow">
                                  <div className="space-y-8">
                                    <div className="flex items-center justify-between">
                                      <div className="flex items-center space-x-4">
                                        <div className="w-14 h-14 bg-purple-600 text-white rounded-full flex items-center justify-center text-xl font-bold shadow-md">
                                          {index + 1}
                                        </div>
                                        <div>
                                    ...
                                    <div className="space-y-6">
                                      <div>
                                        ...
                                        <Input
                                          ...
                                          className={`h-12 text-base ${errors[`step_name_${index}`] ? 'border-red-300 bg-red-50' : ''}`}
                                        />
                                      ...
                                      <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                          <Input
                                            ...
                                            className={`h-12 text-base ${errors[`step_time_${index}`] ? 'border-red-300 bg-red-50' : ''}`}
                                          />
                                          <Select
                                            value={step.timeUnit || 'hours'}
                                            onValueChange={(value) => updateCustomStep(index, 'timeUnit', value)}
                                          >
                                            <SelectTrigger className={`h-12 text-base ${errors[`step_unit_${index}`] ? 'border-red-300 bg-red-50' : ''}`}>
                                              <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent>
        ...
        {/* 🆕 MODAL DE VISUALIZAÇÃO - MELHORADO E EXPANDIDO */}
        <Dialog open={isViewModalOpen} onOpenChange={() => {}}>
          <DialogContent 
            className="w-[98vw] max-w-[1600px] max-h-[95vh] overflow-hidden flex flex-col"
            onEscapeKeyDown={(e) => e.preventDefault()}
            onPointerDownOutside={(e) => e.preventDefault()}
          >
                    ...
                    <div className="lg:col-span-3 space-y-6">
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="p-6 bg-gray-50 rounded-xl">
                          <Label className="text-base font-semibold text-gray-900 block mb-3">Nome do Produto</Label>
                          <p className="text-gray-900 font-medium text-lg">{viewingProduct.displayName}</p>
                        </div>
                        
                        {viewingProduct.description && (
                          <div className="p-6 bg-gray-50 rounded-xl">
                            <Label className="text-base font-semibold text-gray-900 block mb-3">Descrição</Label>
                      ...
                      <div className="flex flex-wrap gap-4">
                        <div className="flex items-center space-x-3 bg-blue-50 px-6 py-4 rounded-xl">
                          <Clock className="h-6 w-6 text-blue-600" />
                          <span className="text-base font-medium text-blue-800">
                            {viewingProduct.customSteps?.length || 0} etapas configuradas
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 bg-green-50 px-6 py-4 rounded-xl">
                          <CheckCircle className="h-6 w-6 text-green-600" />
                          <span className="text-base font-medium text-green-800">Produto Ativo</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {viewingProduct.customSteps && viewingProduct.customSteps.length > 0 && (
                    <div>
                      <div className="flex items-center space-x-4 mb-8">
                        ...
                        <div>
                          <h3 className="text-2xl font-semibold text-gray-900">Timeline de Etapas</h3>
                          <p className="text-base text-gray-600 mt-1">{viewingProduct.customSteps.length} etapas configuradas para este produto</p>
                        </div>
                      </div>
                      
                      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                        {viewingProduct.customSteps.map((step, index) => (
                          <Card key={index} className="p-8 border-l-4 border-l-blue-400 bg-gradient-to-r from-blue-50/50 to-transparent hover:shadow-md transition-shadow">
                            <div className="flex items-start space-x-6">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                                  <div>
                                    <h4 className="font-semibold text-xl text-gray-900">{step.name}</h4>
                                ...
                                {step.description && (
                                  <div className="mt-4 p-4 bg-white rounded-lg border border-gray-100">
                                    <p className="text-base text-gray-700 italic">"{step.description}"</p>
                                  </div>
                                )}
                              </div>
                            </div>
                  ...
                  {viewingProduct.webhookUrl && (
                    <div>
                      <div className="flex items-center space-x-4 mb-6">
                        ...
                        <div>
                          <h3 className="text-2xl font-semibold text-gray-900">Integração CartPanda</h3>
                          <p className="text-base text-gray-600 mt-1">URL do webhook para receber pedidos automaticamente</p>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-3 mb-3">
                              ...
                              <span className="text-base font-medium text-green-800">Webhook Ativo e Funcionando</span>
                            </div>
                            <p className="text-base text-green-600 font-mono break-all bg-white px-4 py-3 rounded border">
                              {viewingProduct.webhookUrl}
                            </p>
                          </div>
                          <Button
                            ...
                            className="bg-green-600 hover:bg-green-700 flex-shrink-0 h-12 px-6"
                          >
        ...
        {/* 🆕 MODAL DE EDIÇÃO - MELHORADO E EXPANDIDO */}
                ...
                <div className="flex-1 overflow-y-auto">
                  <TabsContent value="basic" className="space-y-8 mt-0">
                    <div className="grid grid-cols-1 2xl:grid-cols-3 gap-8">
                      ...
                      <div className="2xl:col-span-2 space-y-8">
                        <div>
                          <Label htmlFor="edit-displayName" className="text-lg font-semibold text-gray-900 flex items-center mb-4">
                        ...
                        <div>
                          <Label htmlFor="edit-description" className="text-lg font-semibold text-gray-900 flex items-center mb-4">
                      ...
                      <div className="2xl:col-span-1">
                        ...
                        <div className="space-y-6">
                          {/* Preview da imagem */}
                          {(imagePreview || newProduct.image) && (
                            <div className="relative w-full aspect-square max-w-80 rounded-xl overflow-hidden border-2 border-orange-200 bg-orange-50 mx-auto">
                              <img 
                                src={imagePreview || newProduct.image} 
                                alt="Preview" 
                                className="w-full h-full object-cover"
                  ...
                  <TabsContent value="steps" className="space-y-6 mt-0">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-orange-50 p-6 rounded-lg border border-orange-200">
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 flex items-center">
                      ...
                      <Button
                        type="button"
                        onClick={addCustomStep}
                        className="bg-orange-600 hover:bg-orange-700 h-14 px-8 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                      >
                        <Plus className="h-5 w-5 mr-2" />
                        Adicionar Etapa
                      </Button>
                    ...
                    {newProduct.customSteps.length === 0 ? (
                      <div className="text-center py-20 bg-gradient-to-br from-gray-50 to-orange-50 rounded-xl border-2 border-dashed border-orange-300">
                        <Sparkles className="h-24 w-24 mx-auto mb-8 text-orange-300" />
                        <h3 className="text-2xl font-semibold text-gray-700 mb-4">
                          Nenhuma etapa configurada
                        </h3>
                        <p className="text-gray-500 mb-10 text-lg px-4 max-w-lg mx-auto">
                        ...
                        <Button 
                          onClick={addCustomStep}
                          className="bg-orange-600 hover:bg-orange-700 h-14 px-10 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                        >
                          <Plus className="h-6 w-6 mr-3" />
                          Criar Primeira Etapa
                        </Button>
                      ...
                      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        {newProduct.customSteps.map((step, index) => (
                          <Card key={index} className="p-8 border-l-4 border-l-orange-400 bg-gradient-to-r from-orange-50/50 to-transparent shadow-sm hover:shadow-md transition-shadow">
                            <div className="space-y-8">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
