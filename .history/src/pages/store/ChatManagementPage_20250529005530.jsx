        ...
        <FadeInUp delay={200}>
          <div className="bg-white/80 backdrop-blur-sm rounded-xl border border-white/50 shadow-xl p-3">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              {/* Tab: Conversas - Layout Corrigido com Scroll */}
              <TabsContent value="chats" className="mt-6">
                <div className="h-[calc(100vh-300px)] min-h-[600px] max-h-[800px]">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
                    {/* Lista de Conversas - usando dados reais */}
                    <div className="h-full flex flex-col">
                      <FadeInUp delay={0} className="h-full flex flex-col">
                        <div className="h-full flex flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-lg">
                          <ChatList 
                    ...
                    <div className="h-full flex flex-col">
                      <FadeInUp delay={200} className="h-full flex flex-col">
                        <div className="h-full flex flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-lg">
